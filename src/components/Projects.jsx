...
const NewProjectCard = ({
  ...
  return (
    ...
    className=" w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-2"
    >
          <div  className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
          <div className="relative pb-48 overflow-hidden">
            <img className="absolute inset-0 h-full w-full object-cover" src={image.src} alt={name}/>
          </div>
          <div className="p-4">
          ...
          <div className="p-4 border-t border-b text-xs ">
            ...
            <button type="button" className="focus:outline-none text-black bg-slate-100 hover:bg-slate-200 focus:ring-4 focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-slate-50 dark:hover:bg-slate-100 dark:focus:ring-slate-200"
